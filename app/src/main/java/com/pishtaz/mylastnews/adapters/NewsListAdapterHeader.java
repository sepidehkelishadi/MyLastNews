 ...
 */
public class NewsListAdapterHeader extends BaseAdapter {
    ...
    public NewsListAdapterHeader(Context inputContext, ArrayList<ItemTO> inputItemTOs){
...
//
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view==null)
        {
            ...
            view = inflater.inflate(R.layout.news_header_row_layout, null);
       ...
       // holder.tvNewsTitleCategory.setText(itemTOs.get(position).getCategory());
        holder.cvCategory.setCardBackgroundColor(Color.parseColor(itemTOs.get(position).getCategory_color()));
